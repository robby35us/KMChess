...
public class ChessGraphics extends Graphics {

	Color lightBackground = Color.LIGHT_GRAY;
	Color darkBackground = Color.DARK_GRAY;
	Color lightPiece = Color.WHITE;
	Color darkPiece = Color.BLACK;
	Color currentBackground = lightBackground;
